// Sourced from https://github.com/payloadcms/payload/blob/main/packages/translations/src/languages/en.ts

/**
 * We have implemented a custom login that requires an OTP code.
 *
 * To keep the login process secure and error messages ambiguous, we have overidden the auth error message for
...
export const enTranslations = {
  ...
  error: {
    ...
    emailOrPasswordIncorrect: 'The email, password or otp provided is incorrect.',
